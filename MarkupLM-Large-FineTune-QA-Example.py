...
page_name_1 = "outputBulleted.html"
...
question = "What category has risk?"

inputs = tokenizer.encode_plus(question, single_html_string, return_tensors="pt", padding="max_length", max_length=50, min_length=10, truncation=True) 
